...
Most common cracked wordlist is rockyou.txt but there are few more in https://weakpass.com/ download the prefered one, keep in mind the language, the location and destination for the attack.

EXAMPLE: Location ESP, the world list must match with the destination attack language.
### SSH
